...
if(NOT CCFITS_FOUND)
  ...
  if(CCFITS_INSTALL_DIR)
    find_path(CCFITS_INCLUDE_DIR CCfits/CCfits PATHS ${CCFITS_INSTALL_DIR} PATH_SUFFIXES include include/CCfits NO_DEFAULT_PATH)
    find_library(CCFITS_LIBRARY CCfits PATHS ${CCFITS_INSTALL_DIR} PATH_SUFFIXES lib NO_DEFAULT_PATH)  
  else()
