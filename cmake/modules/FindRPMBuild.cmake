...
IF (UNIX)
  ...
  if(NOT RPMBUILD_VERSION VERSION_LESS "4.14")
    set(RPMBUILD_HAS_AUTODEBUG TRUE)
  else()
    set(RPMBUILD_HAS_AUTODEBUG FALSE)    
  endif()
...
# all listed variables are TRUE
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(RPMBuild DEFAULT_MSG RPMBUILD_EXECUTABLE RPMBUILD_VERSION RPMBUILD_HAS_AUTODEBUG)

  mark_as_advanced(RPMBUILD_FOUND RPMBUILD_EXECUTABLER PMBUILD_VERSION RPMBUILD_HAS_AUTODEBUG)
