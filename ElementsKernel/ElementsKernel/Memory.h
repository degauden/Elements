...
ELEMENTS_API long parentID(InfoType fetch = ProcessBasics, long pid = -1);
/// Basic Process Information: Affinity mask
ELEMENTS_API long affinityMask(InfoType fetch = ProcessBasics, long pid = -1);
/// Basic Process Information: Exit status (does not really make sense for the running process, but for others!)
ELEMENTS_API long exitStatus(InfoType fetch = ProcessBasics, long pid = -1);
/// Basic Process Information: Base priority
ELEMENTS_API long basePriority(InfoType fetch = ProcessBasics, long pid = -1);
/// Basic Process Information: priority boost
ELEMENTS_API long priorityBoost(InfoType fetch = PriorityBoost, long pid = -1);

/// Basic Process Information: Number of page faults
ELEMENTS_API long numPageFault(InfoType fetch = Memory, long pid = -1);
/// Basic Process Information: Current page file usage
ELEMENTS_API long pagefileUsage(MemoryUnit unit = kByte,
    InfoType fetch = Memory, long pid = -1);
...
ELEMENTS_API long pagedMemory(MemoryUnit unit = kByte, InfoType fetch = Memory,
    long pid = -1);
...
ELEMENTS_API long minMemoryLimit(MemoryUnit unit = kByte,
    InfoType fetch = Quota, long pid = -1);
...
ELEMENTS_API long maxMemoryLimit(MemoryUnit unit = kByte,
    InfoType fetch = Quota, long pid = -1);
/// Basic Process Information: priority boost
ELEMENTS_API long mappedMemory(MemoryUnit unit = kByte, InfoType fetch = Memory,
    long pid = -1);
/// Basic Process Information: priority boost
