...
ELEMENTS_API long pagefileUsage(MemoryUnit unit = MemoryUnit::kByte,
    InfoType fetch = InfoType::Memory, long pid = -1);
/// Basic Process Information: Peak usage of page file
ELEMENTS_API long pagefileUsagePeak(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Memory, long pid = -1);
/// Basic Process Information: Peak usage of page file
ELEMENTS_API long pagefileUsageLimit(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Quota, long pid = -1);

/// Basic Process Information: Current usage of non paged memory
ELEMENTS_API long nonPagedMemory(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Memory, long pid = -1);
/// Basic Process Information: Peak usage of non paged memory
ELEMENTS_API long nonPagedMemoryPeak(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Memory, long pid = -1);
/// System Process Limits: Maximum amount of non-paged memory this process is allowed to use
ELEMENTS_API long nonPagedMemoryLimit(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Quota, long pid = -1);

/// Basic Process Information: Amount of paged memory currently occupied by the process 'pid'
ELEMENTS_API long pagedMemory(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch = InfoType::Memory,
    long pid = -1);
/// Basic Process Information: Maximum of paged memory occupied by the process 'pid'
ELEMENTS_API long pagedMemoryPeak(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Memory, long pid = -1);
/// Basic Process Information: Amount of paged memory that can be occupied by the process 'pid'
ELEMENTS_API long pagedMemoryLimit(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Quota, long pid = -1);

/// System Process Limits: Minimum amount of virtual memory this process may use
ELEMENTS_API long minMemoryLimit(MemoryUnit unit = MemoryUnit::kByte,
...
ELEMENTS_API long maxMemoryLimit(MemoryUnit unit = MemoryUnit::kByte,
    InfoType fetch = InfoType::Quota, long pid = -1);
/// Basic Process Information: priority boost
ELEMENTS_API long mappedMemory(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch = InfoType::Memory,
    long pid = -1);
/// Basic Process Information: priority boost
ELEMENTS_API long mappedMemoryPeak(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Memory, long pid = -1);
/// Basic Process Information: priority boost
ELEMENTS_API long virtualMemory(MemoryUnit unit = MemoryUnit::kByte,
    InfoType fetch = InfoType::Memory, long pid = -1);
/// Basic Process Information: priority boost
ELEMENTS_API long virtualMemoryPeak(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Memory, long pid = -1);
/// System Process Limits: Maximum amount of the page file this process is allowed to use
ELEMENTS_API long virtualMemoryLimit(MemoryUnit unit = MemoryUnit::kByte, InfoType fetch =
    InfoType::Quota, long pid = -1);
}
}
