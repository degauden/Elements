...
BOOST_AUTO_TEST_CASE(median_test) {
  ...
  std::vector<std::vector<int>> input_vec {{1, 2, 3, 10, 101, 102},
                                           {1, 2, 3, 11, 101, 102, 103},
                                           {1, 2, 3, 10, 101, 102, 103, 500},
                                           {1, 2, 3, 11, 101, 102, 103, 500, 501}
                                          };
  std::vector<double> expected_result {6.5, 11, 55.5, 101};
...
BOOST_AUTO_TEST_CASE(order_test) {
  UnitTestExample tested_object{};
  std::vector<int> input_vec_orderd {1, 2, 3, 11, 101, 102, 103};
...
BOOST_AUTO_TEST_CASE(mean_test) {
  UnitTestExample tested_object{};
  std::vector<std::vector<int>> input_vec {{1},{1,2},{1,2,4},{1,2,4,8},{1,2,4,8,16}};
  std::vector<double> expected_result {1,1.5,2.33333333333333333,3.75,6.2};
